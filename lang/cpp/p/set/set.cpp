...
// Just use rever interator
//    std::set<Message, std::greater<Message>> mr;
//
//    mr.insert(msg1);
//    mr.insert(msg2);
//    mr.insert(msg3);
//    mr.insert(msg4);
// 
//    for (std::set<Message>::iterator it=mr.begin(); it!=mr.end(); ++it)
//        std::cout << *it ;
//
 
    for (std::set<Message>::reverse_iterator it=setOfMsgs.rbegin(); it!=setOfMsgs.rend(); ++it)
            std::cout << *it ;
