//Generated:2022-10-05 19:11:50// 6-271
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4572845 || '',
    guid: window.ftGUID_4572845 || '',
    confID: window.ftConfID_4572845 || '0',
    ftReturn: window.ftReturn_4572845 || '',
    keyword: window.ftKeyword_4572845 || '',
    ftId: window.ftId_4572845 || '',
    ftImpId: window.ftImp4572845 && window.ftImp4572845.impID || '',
    gdpr: window.ftImp4572845 && window.ftImp4572845.gdpr || '',
    gdpr_consent: window.ftImp4572845 && window.ftImp4572845.gdpr_consent || '',
    gdpr_pd: window.ftImp4572845 && window.ftImp4572845.gdpr_pd || '',
    us_privacy: window.ftImp4572845 && window.ftImp4572845.us_privacy || '',
    campaignID: '115750',
    cID: '116327',
    pID: '4572845',
    creativeID: '4069501',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115750&sid=18330&plc=4572845&num=&adid=&advid=&adsrv=29&btreg=4572845&btadsrv=flashtalking&crt=4069501&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115750;4572845;4069501;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/it/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224695804-4572845;4069501;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/457/4572845/4069501/image/4069501.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115750;4572845;202;pixel;DV360;DV360FY20AcrobatRTRPlansPageStep1ITDSKBAN728x90/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115750;4572845;4069501;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/it/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display",
    divID: 'ftdiv4572845',
    altimgID: 'ftalt4572845',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4572845 && parseInt(window.ftImp4572845.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4572845') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4572845'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe4572845';
    o.file = 'http://cdn.flashtalking.com/116327/4069501/index.html';
    o.altImg = 'https://servedby.flashtalking.com/imp/8/115750;4572845;204;gif;DV360;DV360FY20AcrobatRTRPlansPageStep1ITDSKBAN728x90/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4572845").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4572845").style.display = "none";
		    }
		});
	}
}(ft4572845));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115750&l2=DV360&l3=4572845&l4=4069501&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115750&l2=DV360&l3=4572845&l4=4069501&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4572845;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4572845;
